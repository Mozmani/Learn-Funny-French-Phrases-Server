    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "Ah, la vache!", translation: "Oh, my cow!" },

            { original: "Devenir chêvre", translation: "To become a goat" },
            { original: "Arrête ton char!", translation: "Stop your chariot" },
            {
              original: "Faire l’andouille",
              translation: "to make the sausage",
            },
            {
              original: "En avoir ras le bol",
              translation: "To have a bowl full of it",
            },
            {
              original: "Donner un coup de main",
              translation: "To give a knock of hand",
            },
            {
              original: "Être au taquet",
              translation: "To be a piece of wood",
            },
            {
